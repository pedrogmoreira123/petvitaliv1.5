 ...
 * @author paje9
 */
public class TiposDePagamentos extends javax.swing.JFrame {

    /**
     * Creates new form TiposDePagamentos
     */
    public TiposDePagamentos() {
        super("PAGAMENTOS");
        initComponents();  
        setResizable(false);
    ...
    private void initComponents() {
        ...
        BotaoNovaComprar.setText("Cancelar Compra");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TiposDePagamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TiposDePagamentos().setVisible(true);
            }
        });
    }
